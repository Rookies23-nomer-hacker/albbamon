...
@Controller
public class MyRecruitmentApplyListController {
    ...
    @Autowired
    public MyRecruitmentApplyListController(RestTemplate restTemplate, ObjectMapper objectMapper) {
        this.restTemplate = restTemplate;
        this.objectMapper = objectMapper;
    }

    @GetMapping("/recruitment/{recruitmentId}/apply-list")
    public String applyList(Model model, @PathVariable("recruitmentId") Long recruitmentId) {
