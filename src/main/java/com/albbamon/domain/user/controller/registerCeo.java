...
private final RestTemplate restTemplate = new RestTemplate();
	...
	@PostMapping("/api/user/ceo")
	public String registerUser(@ModelAttribute CreateUserRequestDto CeoregisterDto) throws JsonProcessingException {
		...
		String Cbody = om.writeValueAsString(CeoregisterDto); // 도시락
		
		//System.out.println("데이터 : " + Cbody );
...
//                String.class  // 응답 타입
//        );
		HttpEntity<String> requestEntity2 = new HttpEntity(Cbody, headers); //총알
		ResponseEntity<String> Cresponse = restTemplate.postForEntity(apiUrl, requestEntity2, String.class);
		//System.out.println("결과 : " + Cresponse.getBody());
