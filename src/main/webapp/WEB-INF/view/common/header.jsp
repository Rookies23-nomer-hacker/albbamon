    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <ul class="nav mb-2 justify-content-center mb-md-0 d-flex flex-wrap">
                <li><a href="${contextPath}/recruitment/list" class="nav-link px-2 text-black" style="font-weight: bold; font-size: 20px;">채용공고</a></li>
            ...
            <div class="d-flex flex-column flex-md-row align-items-center">
                <c:if test="${empty sessionScope.email}">
                    <button type="button" class="btn btn-warning mb-2 mb-md-0" style="border-radius: 30px; font-size: 15px;" onclick="location.href='${contextPath}/api/user/sign-in'">로그인</button>
                    <button type="button" class="btn btn-dark ms-2" style="border-radius: 30px; font-size: 15px;" onclick="location.href='${contextPath}/api/user/join'">회원가입</button>
                </c:if>
                ...
                <c:if test="${not empty sessionScope.email}"> 
                    ...
                    <button type="button" class="btn btn-warning ms-2" style="border-radius: 30px; font-size: 15px;" onclick="location.href='${contextPath}/api/user/log-out'">로그아웃</button>
