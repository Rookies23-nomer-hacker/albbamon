...
<body>
    ...
    <main class="container-wrapper">
        <form id="editForm" action="${contextPath}/notice/${notice.id}" method="POST">
            <!-- 유저 ID를 숨겨서 전송 
            <input type="hidden" id="userId" name="userId" value="${sessionScope.loggedInUserId}">
			-->
            <!-- 제목 -->
            <label for="title">제목</label>
            <input type="text" id="title" name="title" value="${notice.title}" placeholder="제목을 입력하세요." required>

            <!-- 내용 -->
            <label for="contents">내용</label>
            <textarea id="contents" name="contents" placeholder="내용을 입력하세요." required>${notice.contents}</textarea>
        </form>
    </main>
