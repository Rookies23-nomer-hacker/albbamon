...
<head>
    ...
    <script>
    	var sessionAdminId = "${sessionScope.adminId}";
        function toggleMenu() {
            const menu = document.getElementById('menuOptions');
            if (sessionAdminId !== 'admin') {
    ...
    <div class="content-wrapper">
        <div class="join-container">
            <div class="post-header">
                <div>
                    <h1 class="post-title">
                        <c:out value="${notice.title}" default="제목 없음"/>
                    </h1>
                    <div class="post-meta">
                        <c:out value="${post.userName}" default="익명"/> | <c:out value="${notice.createDate}" default="날짜 없음"/>
                    </div>
                    ...
                    <div class="menu-options" id="menuOptions">
                        ...
                        <c:choose>
                            <c:when test="${sessionUserId == post.userId}">
                                <a href="${contextPath}/notice/update/${notice.id}">수정하기</a>
            ...
            <div class="post-content">
                <p><c:out value="${notice.contents}" default="내용이 없습니다."/></p>
            </div>
        </div>
    </div>
