			...
			<div id="PERSONAL">
				<!-- <form action="/find-id" method="POST"> -->
					...
					<div class="auth-methods">
						...
						<label class="radio_label"><input type="radio"name="find-method" value="auth" ><span class="radio_text">본인인증으로 찾기</span></label>
...
<form action="/find-id" method="POST">
						...
						<div class="input-group">
							...
							<div class="phone-group">
								<select id="phone-type">
									<option>휴대폰</option>
									<option>유선전화</option>
								</select> <input type="text" id="phone" name="phone" placeholder="번호 입력"
									>
							</div>
						</div>
					</div>
					...
					<div id="email-form">
						...
						<div class="input-group">
							<div class="input-group-box"><span class="input-group-text">이름</span></div> <input type="text" id="name"
					...
					<div id="auth-form">
						<div class="text-box">
							<span class="text">본인인증을 통해 아이디를 찾을 수 있습니다.</span>
						</div>
					</div>
					<div id="ipin-form">
						<div class="text-box">
							<span class="text">아이핀(I-PIN) 인증으로 아이디를 찾을 수 있습니다.</span>
						</div>
					</div>
			...
			<div id="CORPORATION">
				<form action="/find-id" method="POST">
					...
					<div id="email-form">
						...
						<div class="input-group">
							<div class="input-group-box"><span class="input-group-text">가입자명</span></div> <input type="text" id="name"
								name="name" placeholder="이름 입력" >
							</div>
